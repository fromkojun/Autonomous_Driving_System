...
if("TRUE" STREQUAL "TRUE")
  set(cansend_SOURCE_PREFIX /home/kojun/Autonomous_Driving_System/src/canbus/cansend)
  set(cansend_DEVEL_PREFIX /home/kojun/Autonomous_Driving_System/devel)
  set(cansend_INSTALL_PREFIX "")
  set(cansend_PREFIX ${cansend_DEVEL_PREFIX})
else()
  set(cansend_SOURCE_PREFIX "")
  set(cansend_DEVEL_PREFIX "")
  set(cansend_INSTALL_PREFIX /home/kojun/Autonomous_Driving_System/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'cansend' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/kojun/Autonomous_Driving_System/src/canbus/cansend/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  list(APPEND cansend_EXPORTED_TARGETS ${${cansend_dep}_EXPORTED_TARGETS})
endforeach()
